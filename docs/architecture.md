...
| `bench/` | L2 | portable **benchmark** sweep (detect→format→run→summarize) | `molbuilder bench {generate,prep,summarize,prep-run,siesta-gpu}`; adapters `format_bench`/`format_run` | `protocols/benchmark-workflow.md` |
