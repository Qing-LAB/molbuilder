...
| 2026-08-11 | **The run directory is defined by what it does** — it hands the engine everything it needs and holds everything it produces. Every file in it is *rendered* from the description or *copied* in; a stage directory means the science changed, a `run-` directory means you continued | [`execution/project-layout.md`](?doc=execution/project-layout.md) § 1.0, § 1.5a |
