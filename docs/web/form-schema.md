...
|---|---|
| `optional` | *unset* is a real state and the control must offer it. It is **not** inferable from `null_label`: of **15** optional items only **11** carry one, so five would silently lose their *(auto)* option |
