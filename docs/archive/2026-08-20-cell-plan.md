...
**Role:** plan — **ARCHIVED 2026-08-20**: every acceptance row landed
(the table below is all ✅).  The live rules are
`model/structure-periodicity.md` § 6.1–6.2 and `web/molview.md` § 9.5;
