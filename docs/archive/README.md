...
| `2026-09-21-modify-persistency-investigation.md` | Closed — its one piece of work is BUILT (`modify/structure/page.js` writes `{v:1, loadedFrom, lastSavedTo}` under the page's own tag and reads it at mount, verified 2026-09-21), and its contract question was answered 2026-08-19. One suggestion survives, in `plans/plan.md` § 2 | web/molview.md §§ 11.2–11.3 · web/workspace.md § 4 |
