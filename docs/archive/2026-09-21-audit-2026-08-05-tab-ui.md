# Tab-UI static audit — 2026-08-05 — archived 2026-09-21 (historical record)

**Role:** audit report *(archived)*

> **Not a source of truth.** A point-in-time static audit, kept for its
> evidence. Its surviving findings are tracked in
> [`plans/plan.md`](?doc=plans/plan.md) § 2 as **W1–W4** and **W13**, which is
> the one open list — read those, not this, for what is still open.
>
> The counts in the body are as they were measured on 2026-08-05 and are left
> in place: several have moved since (§ C5's `setStatus` ×6 was already ×12 by
> 2026-08-22), and rewriting an archived record is how the evidence is lost.
