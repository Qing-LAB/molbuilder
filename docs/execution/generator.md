...
| | SIESTA | PySCF |
|---|---|---|
| catalogue rows | 62 items | **54 items** | *(each engine's EXCLUSIVE rows; `net_charge` and `use_gpu` name both and so count in neither — merged 2026-08-19 and 2026-08-23, `template.md` § 6.3)*
