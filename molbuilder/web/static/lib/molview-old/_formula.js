 ...
 * MolView door (index.js) — there is NO `window.molbuilder.fmt` global (a pure stateless helper,
 * so it was dropped once every reader imported it).
 *
 * Moved 2026-07-30 from lib/viewer/mol-format.js.  It is NOT part of the sealed layer: it names
 * no 3Dmol and needs no viewer, which is exactly why § 4 lets `index.js` re-export it beside
 * `mount`.
 */
"use strict";
