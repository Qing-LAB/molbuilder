...
def render_siesta_stage_fdfs(
    ...
    *,
    ...
    property (§ 3) and this function only renders decks.  It is the JobSet
    producer's input (``siesta/stages.py``), where it becomes the dependency
    KIND on the edge out of each stage.
