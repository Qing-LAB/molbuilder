...
:mod:`molbuilder.parsers.transport_json` module's write-side
surface.  The read-side parser lives in
:mod:`molbuilder.parse.sidecars.transport` per the parse-module
contract.
