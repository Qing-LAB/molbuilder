...
def test_jobset_flag_emits_runnable_job_set_json(xyz, tmp_path):
    ...
    # Each stage DECLARES what it would take from a run it is pointed at;
    # `prep --from` names which.  What a job may carry at all is pinned as an
    # equality by test_jobset::test_a_job_declares_exactly_these_five_things.
