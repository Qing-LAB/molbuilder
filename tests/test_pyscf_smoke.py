...
@pytest.mark.smoke
# (test_smoke_h2o_rhf_sto3g_frequencies retired 2026-08-21, T1: its
#  subject -- the compute_frequencies -> thermo.txt in-deck path -- was
#  superseded by the vibration calculation KIND, and the field it set no
#  longer exists on PySCFConfig.  The env skip (pyscf importable) had
#  been hiding that this test could only fail; the vibration E2E
#  (tests/test_vibration_e2e.py) is the live frequencies proof.)
